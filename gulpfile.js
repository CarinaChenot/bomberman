...
// JS task
gulp.task('es6', () => {
  return gulp.src([config.src + 'js/classes/Settings.js', config.src + 'js/classes/Map.js', config.src + 'js/classes/Bomb.js', config.src + 'js/classes/Character.js', config.src + 'js/classes/IA.js', config.src + 'js/main.js'])
  .pipe(plumber({
